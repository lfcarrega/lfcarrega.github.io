...
Virtualização: KVM/QEMU, Libvirt, VMware (conceitual), Incus, Docker  
Redes: Active Directory, TCP/IP, DNS, DHCP, WireGuard, VPN, Rsync, Reverse Proxy, SAMBA  
Scripting/Automação: Bash, Python, PowerShell, AutoHotkey  
